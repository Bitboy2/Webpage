...
vc_add_shortcode_param( 'cryptoland_block_param', 'cryptoland_my_param_settings_field' ); // ignore theme check
function cryptoland_my_param_settings_field( $settings, $value ) {
return '<div class="cryptoland_block_param">'

	 .'</div>'; // section description
}

	$cryptoland_add_responsive_editor = array(
		// 992px resolution
		array(
		'type' 			=> 'css_editor',
		'heading' 		=> esc_html__( 'Max width 992px resolution', 'cryptoland' ),
		'param_name' 	=> 'cryptoland_vc_css_992',
		'description' 	=> esc_html__( 'These options for 992px resolution - responsive medya', 'cryptoland' ),
		'group'			=> esc_html__('992px', 'cryptoland' ),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Background position', 'cryptoland' ),
		'param_name'	=> 'cryptoland_mdbg_pos',
		'description'	=> esc_html__('Select background-position', 'cryptoland' ),
		'group'			=> esc_html__('992px', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select a option',   'cryptoland' )	=> '',
			esc_html__('center',   		'cryptoland' )	=> 'center',
			esc_html__('left',    		'cryptoland' )	=> 'left',
			esc_html__('right',    		'cryptoland' )	=> 'right',
			esc_html__('top',   		'cryptoland' )	=> 'top',
			esc_html__('bottom',   		'cryptoland' )	=> 'bottom',
			esc_html__('center-left',   'cryptoland' )	=> 'center-left',
			esc_html__('center-right',  'cryptoland' )	=> 'center-right',
			esc_html__('center-top',    'cryptoland' )	=> 'center-top',
			esc_html__('center-bottom', 'cryptoland' )	=> 'center-bottom',
			esc_html__('left-center',   'cryptoland' )	=> 'left-center',
			esc_html__('left-top',   	'cryptoland' )	=> 'left-top',
			esc_html__('left-bottom',   'cryptoland' )	=> 'left-bottom',
			esc_html__('right-center',  'cryptoland' )	=> 'right-center',
			esc_html__('right-top',   	'cryptoland' )	=> 'right-top',
			esc_html__('right-bottom',  'cryptoland' )	=> 'right-bottom',
			esc_html__('top-center',   	'cryptoland' )	=> 'top-center',
			esc_html__('top-left',   	'cryptoland' )	=> 'top-left',
			esc_html__('top-right',   	'cryptoland' )	=> 'top-right',
			esc_html__('bottom-center', 'cryptoland' )	=> 'bottom-center',
			esc_html__('bottom-left',   'cryptoland' )	=> 'bottom-left',
			esc_html__('bottom-right',  'cryptoland' )	=> 'bottom-right',
		),
		'edit_field_class' => 'vc_col-sm-6',
		),
		array(
		'type' 			=> 'checkbox',
		'heading' 		=> esc_html__( 'Disable background image?', 'cryptoland' ),
		'param_name' 	=> 'cryptoland_hidebg_992',
		'description' 	=> esc_html__( 'f checked, disables background image on devices with a maximum width of 992 pixels.', 'cryptoland' ),
		'value' 		=> array( esc_html__( 'Yes', 'cryptoland' ) => 'off' ),
		'group'			=> esc_html__('992px', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-6',
		),
		// 768px resolution
		array(
		'type' 			=> 'css_editor',
		'heading' 		=> esc_html__( 'Max width 768px resolution', 'cryptoland' ),
		'param_name' 	=> 'cryptoland_vc_css_768',
		'description' 	=> esc_html__( 'These options for 768px resolution - responsive medya', 'cryptoland' ),
		'group'			=> esc_html__('768px', 'cryptoland' ),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Background position', 'cryptoland' ),
		'param_name'	=> 'cryptoland_smbg_pos',
		'description'	=> esc_html__('Select background-position', 'cryptoland' ),
		'group'			=> esc_html__('768px', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select a option',   'cryptoland' )	=> '',
		...
		'type' 			=> 'checkbox',
		'heading' 		=> esc_html__( 'Disable background image?', 'cryptoland' ),
		'param_name' 	=> 'cryptoland_hidebg_768',
		'description' 	=> esc_html__( 'f checked, disables background image on devices with a maximum width of 768 pixels.', 'cryptoland' ),
		'value' 		=> array( esc_html__( 'Yes', 'cryptoland' ) => 'off' ),
		'group'			=> esc_html__('768px', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-6',
		),
		...
		array(
		'type' 			=> 'css_editor',
		'heading' 		=> esc_html__( 'Max width 576px resolution', 'cryptoland' ),
		'param_name' 	=> 'cryptoland_vc_css_576',
		'description' 	=> esc_html__( 'These options for 576px resolution - responsive medya', 'cryptoland' ),
		'group'			=> esc_html__('576px', 'cryptoland' ),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Background position', 'cryptoland' ),
		'param_name'	=> 'cryptoland_xsbg_pos',
		'description'	=> esc_html__('Select background-position', 'cryptoland' ),
		'group'			=> esc_html__('576px', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select a option',   'cryptoland' )	=> '',
		...
		'type' 			=> 'checkbox',
		'heading' 		=> esc_html__( 'Disable background image?', 'cryptoland' ),
		'param_name' 	=> 'cryptoland_hidebg_576',
		'description' 	=> esc_html__( 'f checked, disables background image on devices with a maximum width of 576 pixels.', 'cryptoland' ),
		'value' 		=> array( esc_html__( 'Yes', 'cryptoland' ) => 'off' ),
		'group'			=> esc_html__('576px', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-6',
		),
	...
	/*	Shortcode Filter
	/*-----------------------------------------------------------------------------------*/
	  function cryptoland_add_vc_shortcode_extra() {
		//Get current values stored in the color param in "Call to Action" element
		$param = WPBMap::getParam( 'vc_row', 'full_width' );
		//Append new value to the 'value' array
		$param['value'][esc_html__( 'Null', 'cryptoland' )] = 'clear_layout';
		//Finally "mutate" param with new values
		vc_update_shortcode_param( 'vc_row', $param );
		//Get current values stored in the color param in "Call to Action" element
		$param = WPBMap::getParam( 'vc_row', 'parallax' );
		//Append new value to the 'value' array
		$param['value'][esc_html__( 'Theme scroll (extra)', 'cryptoland' )] = 'cryptoland-scroll';
		$param['value'][esc_html__( 'Theme scale (extra)', 'cryptoland' )] = 'cryptoland-scale';
		$param['value'][esc_html__( 'Theme opacity (extra)', 'cryptoland' )] = 'cryptoland-opacity';
		$param['value'][esc_html__( 'Theme scroll-opacity (extra)', 'cryptoland' )] = 'cryptoland-scroll-opacity';
		$param['value'][esc_html__( 'Theme scale-opacity (extra)', 'cryptoland' )] = 'cryptoland-scale-opacity';
		 //Finally "mutate" param with new values
		vc_update_shortcode_param( 'vc_row', $param );
		//Get current values stored in the color param in "Call to Action" element
		...
		$param['value'][esc_html__( 'Theme Transparent', 'cryptoland' )] = 'cryptoland_vc_tta-color-transparent';
		$param['value'][esc_html__( 'Theme Blue', 'cryptoland' )] = 'cryptoland_vc_tta-color-blue';
		$param['value'][esc_html__( 'Theme White', 'cryptoland' )] = 'cryptoland_vc_tta-color-white';
		$param['value'][esc_html__( 'Theme Purple', 'cryptoland' )] = 'cryptoland_vc_tta-color-purple';
		vc_update_shortcode_param('vc_tta_accordion', $param);

		//vc_single_image
		$param = WPBMap::getParam('vc_single_image', 'onclick');
		$param['value'][esc_html__('Theme popup image', 'cryptoland')] = 'mfp';
		vc_update_shortcode_param('vc_single_image', $param);
		$param = WPBMap::getParam('vc_single_image', 'onclick');
		$param['value'][esc_html__('Theme popup video', 'cryptoland')] = 'mfp-video';
		vc_update_shortcode_param('vc_single_image', $param);
		...
		$param['value'][esc_html__('Theme Owl-carousel Slider', 'cryptoland')] = 'owl_slider';
		vc_update_shortcode_param('vc_gallery', $param);
		$param = WPBMap::getParam('vc_gallery', 'onclick');
		$param['value'][esc_html__('Theme Lightbox Gallery', 'cryptoland')] = 'mfp';
		vc_update_shortcode_param('vc_gallery', $param);

	  }
	  add_action( 'vc_after_init', 'cryptoland_add_vc_shortcode_extra' );



		//FOR ROW EXTRA RESPONSIVE
		$cryptoland_vc_row_extra_attributes = array(

		//new options for paralax
		array(
		'type' 			=> 'textfield',
		'heading' 		=> esc_html__( 'Theme Parallax speed', 'cryptoland' ),
		'param_name' 	=> 'cryptoland_parallax_speed',
		'value' 		=> '0.2',
		'description' 	=> esc_html__( 'Enter parallax speed ratio (Note: Default value is 0.2, min value is 0.1)', 'cryptoland' ),
		'dependency' 	=> array(
			'element' 	=> 'parallax',
			'value'   	=> array( 'cryptoland-scroll', 'cryptoland-scale','cryptoland-opacity','cryptoland-scroll-opacity','cryptoland-scale-opacity' ),
		),
		),
		array(
		'type' 			=> 'checkbox',
		'heading' 		=> esc_html__( 'Disable Parallax on mobile devices?', 'cryptoland' ),
		'param_name' 	=> 'cryptoland_mobile_parallax',
		'description' 	=> esc_html__( 'Disables parallax on mobile devices if checked.', 'cryptoland' ),
		'value' 		=> array( esc_html__( 'Yes', 'cryptoland' ) => 'off' ),
		'dependency' 	=> array(
			'element' 	=> 'parallax',
			'value'   	=> array( 'cryptoland-scroll', 'cryptoland-scale','cryptoland-opacity','cryptoland-scroll-opacity','cryptoland-scale-opacity' ),
		...
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Background size', 'cryptoland' ),
		'param_name'	=> 'cryptoland_bg_size',
		'description'	=> esc_html__('Select background-attachment', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select a option',   'cryptoland' )	=> '',
			esc_html__('auto',   			'cryptoland' )	=> 'auto',
			esc_html__('cover',   			'cryptoland' )	=> 'cover',
			esc_html__('contain',    		'cryptoland' )	=> 'contain',
			esc_html__('Custom size',	'cryptoland' )	=> 'custom',
			),
		'dependency' 	=> array(
			'element' 	=> 'parallax',
			'value'   	=> array( 'cryptoland-scroll', 'cryptoland-scale','cryptoland-opacity','cryptoland-scroll-opacity','cryptoland-scale-opacity' ),
		...
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Custom background size', 'cryptoland' ),
		'param_name'	=> 'cryptoland_custom_bg_size',
		'description'	=> esc_html__('Set background image size.e.g: 100% or 400px or 300px 500px or 50% 50% or .....etc', 'cryptoland' ),
		'dependency' 	=> array(
			'element' 	=> 'cryptoland_bg_size',
			'value'   	=> 'custom'
		),
		),
		array(
		...
		'value'			=> array(
			...
			esc_html__('bottom-left',   'cryptoland' )	=> 'bottom left',
			esc_html__('bottom-right',  'cryptoland' )	=> 'bottom right',
			esc_html__('Custom position','cryptoland' )	=> 'custom',
			),
		'dependency' 	=> array(
			'element' 	=> 'parallax',
			'value'   	=> array( 'cryptoland-scroll', 'cryptoland-scale','cryptoland-opacity','cryptoland-scroll-opacity','cryptoland-scale-opacity' ),
		...
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Custom background position', 'cryptoland' ),
		'param_name'	=> 'cryptoland_custom_bg_pos',
		'description'	=> esc_html__('Set background image position.e.g: 100% or 400px or 300px 500px or 50% 50% or .....etc', 'cryptoland' ),
		'dependency' 	=> array(
			'element' 	=> 'cryptoland_bg_pos',
			'value'   	=> 'custom'
		),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Background repeat', 'cryptoland' ),
		'param_name'	=> 'cryptoland_bg_repet',
		'description'	=> esc_html__('Select background-repeat', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select a option',  'cryptoland' )	=> '',
			esc_html__('no-repeat',   		'cryptoland' )	=> 'no-repeat',
			esc_html__('repeat',   			'cryptoland' )	=> 'repeat',
			esc_html__('repeat-x',   		'cryptoland' )	=> 'repeat-x',
			esc_html__('repeat-y',   		'cryptoland' )	=> 'repeat-y',
		),
		'dependency' 	=> array(
			'element' 	=> 'parallax',
			'value'   	=> array( 'cryptoland-scroll', 'cryptoland-scale','cryptoland-opacity','cryptoland-scroll-opacity','cryptoland-scale-opacity' ),
		...
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Parallax background opacity', 'cryptoland' ),
		'param_name'	=> 'cryptoland_parallax_bg_opacity',
		'description'	=> esc_html__('Select background-attachment', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select a option',   'cryptoland' )	=> '',
			esc_html__('0.1',   'cryptoland' )	=> '01',
			esc_html__('0.2',   'cryptoland' )	=> '02',
			esc_html__('0.3',   'cryptoland' )	=> '03',
			esc_html__('0.4',   'cryptoland' )	=> '04',
			esc_html__('0.5',   'cryptoland' )	=> '05',
			esc_html__('0.6',   'cryptoland' )	=> '06',
			esc_html__('0.7',   'cryptoland' )	=> '07',
			esc_html__('0.8',   'cryptoland' )	=> '08',
			esc_html__('0.9',   'cryptoland' )	=> '09',
			esc_html__('1',   	'cryptoland' )	=> '1',
			),
		'dependency' 	=> array(
			'element' 	=> 'parallax',
			'value'   	=> array( 'cryptoland-scroll', 'cryptoland-scale','cryptoland-opacity','cryptoland-scroll-opacity','cryptoland-scale-opacity' ),
		...
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Row overflow', 'cryptoland' ),
		'param_name'	=> 'cryptoland_row_overflow',
		'description'	=> esc_html__('Select row overflow', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select a option',  'cryptoland' )	=> '',
			esc_html__('visible',   		'cryptoland' )	=> 'overflow_visible',
			esc_html__('hidden',   			'cryptoland' )	=> 'overflow_hidden',
		),
		),
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Row Z-index', 'cryptoland' ),
		'param_name'	=> 'cryptoland_bg_zindex',
		'description'	=> esc_html__('Add z-idex number for overflowed row', 'cryptoland' ),
		'dependency' 	=> array(
			'element' 	=> 'cryptoland_row_overflow',
		...
		array(
		'type' 			=> 'colorpicker',
		'heading' 		=> esc_html__( 'Row overlay color', 'cryptoland' ),
		'param_name' 	=> 'vc_overlayclr',
		'description' 	=> esc_html__( 'Add overlay color on background image.', 'cryptoland' ),
		'group'			=> esc_html__('Design Options', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-4',
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Background position', 'cryptoland' ),
		'param_name'	=> 'cryptoland_lgbg_pos',
		'description'	=> esc_html__('Select background-position', 'cryptoland' ),
		'group'			=> esc_html__('Design Options', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select a option',   'cryptoland' )	=> '',
	...
	$cryptoland_vc_single_img_extra = array(
		//overlay image
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Youtube or Vimeo Link', 'cryptoland'),
		'param_name'	=> 'cryptoland_theme_mfpvideo',
		'description'	=> esc_html__('Add Yotube or  Vimeo link', 'cryptoland'),
		'std'			=> 'https://www.youtube.com/watch?v=7e90gBu4pas',
		'weight'		=> -1,
		'dependency' 	=> array(
			'element' 	=> 'onclick',
			'value' 	=> 'mfp-video',
		...
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Image Hover Style', 'cryptoland' ),
		'param_name'	=> 'cryptoland_hover_style',
		'group'			=> esc_html__('Cryptoland Extra', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select a option',   'cryptoland' )	=> '',
			esc_html__('opacity',			'cryptoland' )	=> 'has_opacity',
			esc_html__('overlay color',   	'cryptoland' )	=> 'has_overlay',
			esc_html__('scale transform',  	'cryptoland' )	=> 'has_transform',
			esc_html__('move up',  			'cryptoland' )	=> 'has_moveup',
		),
		),
		//Opacity
		array(
		...
		'param_name'	=> 'cryptoland_custom_opacity',
		'description'	=> esc_html__('Use simple number.Min: 0 and Max: 1. example:0.65', 'cryptoland' ),
		'group'			=> esc_html__('Cryptoland Extra', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-6',
		'dependency' 	=> array(
			'element' 	=> 'cryptoland_hover_style',
			'value' 	=> 'has_opacity',
		),
		),
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Hover Opacity', 'cryptoland' ),
		'param_name'	=> 'cryptoland_custom_hvr_opacity',
		'description'	=> esc_html__('Use simple number.Min: 0 and Max: 1. example:0.9', 'cryptoland' ),
		'group'			=> esc_html__('Cryptoland Extra', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-6',
		'dependency' 	=> array(
			'element' 	=> 'cryptoland_hover_style',
		...
		array(
		'type'			=> 'colorpicker',
		'heading'		=> esc_html__('Overlay color', 'cryptoland'),
		'param_name'	=> 'cryptoland_custom_overlay',
		'description'	=> esc_html__('Change overlay color.default: transparent black', 'cryptoland'),
		'group'			=> esc_html__('Cryptoland Extra', 'cryptoland' ),
		'dependency' 	=> array(
			'element' 	=> 'cryptoland_hover_style',
			'value' 	=> 'has_overlay',
		...
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Scale', 'cryptoland' ),
		'param_name'	=> 'cryptoland_custom_transform',
		'description'	=> esc_html__('Enter the maximum growth scale of the image.example:1.1', 'cryptoland' ),
		'group'			=> esc_html__('Cryptoland Extra', 'cryptoland' ),
		'dependency' 	=> array(
			'element' 	=> 'cryptoland_hover_style',
			'value' 	=> 'has_transform',
		...
		array(
		'type' 			=> 'checkbox',
		'heading' 		=> esc_html__( 'Make the same height ?', 'cryptoland' ),
		'param_name' 	=> 'cryptoland_same_height',
		'description' 	=> esc_html__( 'This options sets the pictures to the same height.', 'cryptoland' ),
		...
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Image max-width', 'cryptoland' ),
		'param_name'	=> 'cryptoland_maxwidth',
		'description'	=> esc_html__('Use simple number in px or unit.example:62px, 50%....etc', 'cryptoland' ),
		'group'			=> esc_html__('Cryptoland Extra', 'cryptoland' ),
		),
		...
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Image alignment', 'cryptoland' ),
   ...
   //FOR CUSTOM HEADING
	$cryptoland_vc_custom_heading_extra = array(
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Heading link hover style', 'cryptoland' ),
		'param_name'	=> 'cryptoland_ch_link_style',
		'description'	=> esc_html__('You can select an option for custom heading hover style', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select', 				'cryptoland' )	=> '',
			esc_html__('Link hover underline', 	'cryptoland' )	=> 'hover-underline',
			esc_html__('Link hover opacity', 	'cryptoland' )	=> 'hover-opacity',
			esc_html__('normal', 				'cryptoland' )	=> 'normal',
		),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Theme heading style', 'cryptoland' ),
		'param_name'	=> 'cryptoland_ch_style',
		'description'	=> esc_html__('You can select an option for subtitle style', 'cryptoland' ),
		'group' 	  	=> esc_html__('Cryptoland', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select', 			'cryptoland' )	=> '',
			esc_html__('Subtitle style 1', 	'cryptoland' )	=> 'style-tire',
			esc_html__('List marker style', 'cryptoland' )	=> 'list-marker',
			esc_html__('List check style', 	'cryptoland' )	=> 'list-check',
			esc_html__('List stat designations style', 	'cryptoland' )	=> 'list-stat',
			esc_html__('normal', 			'cryptoland' )	=> 'normal',
		),
		),
		array(
		'type'			=> 'colorpicker',
		'heading'		=> esc_html__('Before title line color', 'cryptoland'),
		'param_name'	=> 'list_stat_clr',
		'description'	=> esc_html__('Add before title line color.', 'cryptoland'),
		'group'			=> esc_html__('Cryptoland', 'cryptoland' ),
			'dependency'=> array(
			'element' 	=> 'cryptoland_ch_style',
			'value'   	=> 'list-stat'
			),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Theme heading font family', 'cryptoland' ),
		'param_name'	=> 'cryptoland_ch_f',
		'description'	=> esc_html__('You can select an option for using general theme heading font family', 'cryptoland' ),
		'group' 	  	=> esc_html__('Cryptoland', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select', 	'cryptoland' )	=> '',
			esc_html__('Catamaran', 'cryptoland' )	=> 'f-catamaran',
			esc_html__('Raleway', 	'cryptoland' )	=> 'f-raleway',
			esc_html__('Roboto', 	'cryptoland' )	=> 'f-roboto',
		),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Theme colors', 'cryptoland' ),
		'param_name'	=> 'cryptoland_ch_clr',
		'description'	=> esc_html__('You can select an option for using general theme colors', 'cryptoland' ),
		'group' 	  	=> esc_html__('Cryptoland', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select', 'cryptoland' )			=> '',
			esc_html__('link-opacity',  'cryptoland' )	=> 'link-opacity',
			esc_html__('white',    		'cryptoland' )	=> 'clr-white',
			esc_html__('black',    		'cryptoland' )	=> 'clr-black',
			esc_html__('dark',     		'cryptoland' )	=> 'clr-dark',
			esc_html__('lightdark',     'cryptoland' )	=> 'clr-lightdark',
			esc_html__('grey',     		'cryptoland' )	=> 'clr-grey',
			esc_html__('lightgrey',    	'cryptoland' )	=> 'clr-lightgrey',
			esc_html__('deepgrey',   	'cryptoland' )	=> 'clr-deepgrey',
			esc_html__('rose',     		'cryptoland' )	=> 'clr-rose',
			esc_html__('red',   		'cryptoland' )	=> 'clr-red',
			esc_html__('yellow',   		'cryptoland' )	=> 'clr-yellow',
			esc_html__('green',     	'cryptoland' )	=> 'clr-green',
			esc_html__('blue',     		'cryptoland' )	=> 'clr-blue',
			esc_html__('blue2',     	'cryptoland' )	=> 'clr-blue2',
			esc_html__('lightblue',     'cryptoland' )	=> 'clr-lightblue',
			esc_html__('deepblue',      'cryptoland' )	=> 'clr-deepblue',
			esc_html__('purple',     	'cryptoland' )	=> 'clr-purple',
			esc_html__('mediumpurple',  'cryptoland' )	=> 'clr-mediumpurple',
			esc_html__('lightpurple', 	'cryptoland' )	=> 'clr-lightpurple',
		),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Font-weight', 'cryptoland' ),
		'param_name'	=> 'cryptoland_ch_fw',
		'description'	=> esc_html__('You can select an option for using general theme font weight', 'cryptoland' ),
		'group' 	  	=> esc_html__('Cryptoland', 'cryptoland' ),
		'value'		=> array(
			esc_html__('Select',			'cryptoland' )	=> '',
			esc_html__('lighter',  			'cryptoland' )	=> 'fw-lighter',
			esc_html__('normal',   			'cryptoland' )	=> 'fw-normal',
			esc_html__('bold',     			'cryptoland' )	=> 'fw-bold',
			esc_html__('bolder',   			'cryptoland' )	=> 'fw-bolder',
			esc_html__('weight-100',      	'cryptoland' )	=> 'fw100',
			esc_html__('weight-200',      	'cryptoland' )	=> 'fw200',
			esc_html__('weight-300',      	'cryptoland' )	=> 'fw300',
			esc_html__('weight-400',      	'cryptoland' )	=> 'fw400',
			esc_html__('weight-500',      	'cryptoland' )	=> 'fw500',
			esc_html__('weight-600',      	'cryptoland' )	=> 'fw600',
			esc_html__('weight-700',      	'cryptoland' )	=> 'fw700',
			esc_html__('weight-800',      	'cryptoland' )	=> 'fw800',
			esc_html__('weight-900',      	'cryptoland' )	=> 'fw900',
		),
		),
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Letter-spacing', 'cryptoland' ),
		'param_name'	=> 'cryptoland_ch_lts',
		'description'	=> esc_html__('Set letter-spacing.Note: minimum: -5 step:1 maximum:5', 'cryptoland' ),
		'group' 	  	=> esc_html__('Cryptoland', 'cryptoland' ),
		),
		// 992px
		array(
		'type' 			=> 'cryptoland_block_param',
		'holder' 		=> 'div',
		'heading' 		=> esc_html__('Resposive options ( maximum device width 992px )', 'cryptoland'),
		'param_name' 	=> '992_desc',
		'group'			=> esc_html__('992px', 'cryptoland' ),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Theme heading style', 'cryptoland' ),
		'param_name'	=> 'cryptoland_md_ch_style',
		'description'	=> esc_html__('You can select an option for subtitle style', 'cryptoland' ),
		'group' 	  	=> esc_html__('992px', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select', 			'cryptoland' )	=> '',
		...
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Text-align', 'cryptoland' ),
		'param_name'	=> 'res_md_align',
		'description' 	=> esc_html__( 'You can set the text alignment for devices smaller than 992 pixels in screen size.', 'cryptoland' ),
		'group'			=> esc_html__('992px', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-3',
		'value'			=> array(
			esc_html__('Select alignment', 	'cryptoland' )	=> '',
			esc_html__('center',			'cryptoland' )	=> 'center',
			esc_html__('left',				'cryptoland' )	=> 'left',
			esc_html__('right',				'cryptoland' )	=> 'right',
		),
		...
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Font-size', 'cryptoland' ),
		'param_name'	=> 'res_md_ch_fs',
		'description'	=> esc_html__('Use simple number.Note: minimum: 10 step:1 maximum:100', 'cryptoland' ),
		'group' 	  	=> esc_html__('992px', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-3',
		),
		array(
		'type'			=> 'textfield',
		'heading'		=> esc_html__('Line-height', 'cryptoland' ),
		...
		'description'	=> esc_html__('Use simple number.Note: minimum: 1 step:1 maximum:100', 'cryptoland' ),
		'group' 	  	=> esc_html__('992px', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-3',
		),
		// RESPOSIVE 768PX
		...
		'type' 			=> 'cryptoland_block_param',
		'holder' 		=> 'div',
		'heading' 		=> esc_html__('Resposive options ( maximum device width 768px )', 'cryptoland'),
		'param_name' 	=> '768_desc',
		'group'			=> esc_html__('768px', 'cryptoland' ),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Theme heading style', 'cryptoland' ),
		'param_name'	=> 'cryptoland_sm_ch_style',
		'description'	=> esc_html__('You can select an option for subtitle style', 'cryptoland' ),
		'group' 	  	=> esc_html__('768px', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select', 			'cryptoland' )	=> '',
		...
		'description' 	=> esc_html__( 'You can set the text alignment for devices smaller than 768 pixels in screen size.', 'cryptoland' ),
		'group'			=> esc_html__('768px', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-3',
		'value'			=> array(
			esc_html__('Select alignment', 	'cryptoland' )	=> '',
		...
		'description'	=> esc_html__('Use simple number.Note: minimum: -5 step:1 maximum:5', 'cryptoland' ),
		'group' 	  	=> esc_html__('768px', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-3',
		),
		// RESPOSIVE 576PX
		...
		'type' 			=> 'cryptoland_block_param',
		'holder' 		=> 'div',
		'heading' 		=> esc_html__('Resposive options ( maximum device width 576px )', 'cryptoland'),
		'param_name' 	=> '576_desc',
		'group'			=> esc_html__('576px', 'cryptoland' ),
		),
		array(
		'type'			=> 'dropdown',
		'heading'		=> esc_html__('Theme heading style', 'cryptoland' ),
		'param_name'	=> 'cryptoland_xs_ch_style',
		'description'	=> esc_html__('You can select an option for subtitle style', 'cryptoland' ),
		'group' 	  	=> esc_html__('576px', 'cryptoland' ),
		'value'			=> array(
			esc_html__('Select', 			'cryptoland' )	=> '',
		...
		'description' 	=> esc_html__( 'You can set the text alignment for devices smaller than 576 pixels in screen size.', 'cryptoland' ),
		'group'			=> esc_html__('576px', 'cryptoland' ),
		'edit_field_class' => 'vc_col-sm-3',
		'value'			=> array(
			esc_html__('Select alignment', 	'cryptoland' )	=> '',
		...
		// animation for inner columnaos
$cryptoland_inner_column_animation = array(
		array(
		'type'          => 'checkbox',
		'heading'       => esc_html__('Add animation?', 'cryptoland' ),
		'param_name'    => 'cryptoland_addanim',
		'value' 		=> array( esc_html__( 'Yes', 'cryptoland' ) => 'yes' ),
		'edit_field_class' => 'vc_col-sm-4',
		),
		array(
	...
	//FOR CUSTOM HEADING
	vc_add_params( 'vc_custom_heading', $cryptoland_vc_custom_heading_extra );
	vc_add_params( 'vc_custom_heading', $cryptoland_add_responsive_editor );
	//FOR ROW
	vc_add_params( 'vc_row', $cryptoland_vc_row_extra_attributes );
	vc_add_params( 'vc_row', $cryptoland_add_responsive_editor );
	//FOR INNER ROW
	vc_add_params( 'vc_row_inner', $cryptoland_add_responsive_editor );
	//FOR COLUMN
	vc_add_params( 'vc_column', $cryptoland_add_responsive_editor );
	//FOR COLUMN INNER
	vc_add_params( 'vc_column_inner', $cryptoland_add_responsive_editor );
	vc_add_params( 'vc_column_inner', $cryptoland_inner_column_animation );
	//FOR SINGLE IMAGE
	vc_add_params( 'vc_single_image', $cryptoland_vc_single_img_extra );
	vc_add_params( 'vc_single_image', $cryptoland_add_responsive_editor );


	// Add new custom font to Font Family selection in icon box module
	function cryptoland_add_ionicons( ) {
		$param = WPBMap::getParam( 'vc_icon', 'type' );
		$param['value'][esc_html__( 'Ionicons', 'cryptoland' )] = 'ionicons';
		vc_update_shortcode_param( 'vc_icon', $param );
		$param1 = WPBMap::getParam( 'vc_icon', 'size' );
		$param1['value'][esc_html__( 'Theme size', 'cryptoland' )] = 'c-summary-1-icon';
		vc_update_shortcode_param( 'vc_icon', $param1 );
	}
	add_filter( 'init', 'cryptoland_add_ionicons', 40 );
	// Add font picker setting to icon box module when you select your font family from the dropdown
	function cryptoland_add_font_picker() {
		vc_add_param( 'vc_icon', array(
				'type' 			=> 'iconpicker',
				'weight' 		=> 1,
				'heading' 		=> esc_html__( 'Icon', 'cryptoland' ),
	...
	add_filter( 'vc_after_init', 'cryptoland_add_font_picker', 40 );
	// Add array of your fonts so they can be displayed in the font selector
	function cryptoland_icon_array() {
		return array(
         ...
         array('ionicons ion-bonfire' => 'bonfire'),
         ...
         array('ionicons ion-ribbon-a' => 'ribbon-a'),
         array('ionicons ion-ribbon-b' => 'ribbon-b'),
	...
	add_filter( 'vc_iconpicker-type-ionicons', 'cryptoland_icon_array' );
	// Add new custom font to Font Family selection in icon box module
	function cryptoland_add_flaticon( ) {
		$param = WPBMap::getParam( 'vc_icon', 'type' );
		$param['value'][esc_html__( 'Flaticon', 'cryptoland' )] = 'flaticon';
		vc_update_shortcode_param( 'vc_icon', $param );
	}
	add_filter( 'init', 'cryptoland_add_flaticon', 40 );
	// Add font picker setting to icon box module when you select your font family from the dropdown
	function cryptoland_add_font_flaticon_picker() {
		vc_add_param( 'vc_icon', array(
				'type' => 'iconpicker',
				'weight' => 1,
				'heading' => esc_html__( 'Icon', 'cryptoland' ),
	...
	add_filter( 'vc_after_init', 'cryptoland_add_font_flaticon_picker', 40 );
	function cryptoland_flaticonicon_array() {
		return array(
	...
	add_filter( 'vc_iconpicker-type-flaticon', 'cryptoland_flaticonicon_array' );
	/**
	 * Register Backend and Frontend CSS Styles
	 */
	add_action( 'vc_base_register_front_css', 'cryptoland_vc_iconpicker_base_register_css' );
	add_action( 'vc_base_register_admin_css', 'cryptoland_vc_iconpicker_base_register_css' );
	function cryptoland_vc_iconpicker_base_register_css(){
	    wp_register_style('ionicons', get_stylesheet_directory_uri() . '/framework/dist/ion-icons/ionicon-stylesheet.css');
	    wp_register_style('flaticon', get_stylesheet_directory_uri() . '/framework/dist/flaticon/flaticon.css');
	}
	/**
	 * Enqueue Backend and Frontend CSS Styles
	 */
	add_action( 'vc_backend_editor_enqueue_js_css', 'cryptoland_vc_iconpicker_editor_jscss' );
	add_action( 'vc_frontend_editor_enqueue_js_css', 'cryptoland_vc_iconpicker_editor_jscss' );
	function cryptoland_vc_iconpicker_editor_jscss(){
	 ...
	 */
	add_action('vc_enqueue_font_icon_element', 'cryptoland_enqueue_font_ionicons');
	function cryptoland_enqueue_font_ionicons($font){
	    switch ( $font ) {
	        case 'ionicons':
			wp_enqueue_style( 'ionicons' );
			break;
